...
class Sidebar(ctk.CTkFrame):
    def __init__(self, master, on_tab_change):
        ...
        ctk.CTkLabel(footer_frame, image=icon_version, text="  Version 2.1.0", compound="left", font=Styles.FONT_DESC, text_color=Styles.TEXT_SECONDARY, anchor="w").pack(fill="x")
